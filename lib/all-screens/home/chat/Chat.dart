                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                      ...
                                                      margin: EdgeInsets.only(right: 10),
                                                      decoration: BoxDecoration(
                                                        color:provider.localmessage[index].message=="This Message was Deleted"?Colors.grey[300]: Color(0xffF5FCFF),
                                                        borderRadius: BorderRadius.circular(10),
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          ...
                                          Spacer(),
                                          Text("${provider.individualselect.length} ${AppLocalizations.of(context)!.selected}",style: TextStyle(color: Colors.black,fontSize: 15),),
                                          Spacer(),
                                          GestureDetector(
                                              onTap: (){
                                                ClickSound.buttonClickYes();
                                              ...
                                              child: Text(AppLocalizations.of(context)!.cancel,style: TextStyle(color: Colors.black,fontSize: 15),)),
                                          SizedBox(width: 10,),
                                        ],
                                      ),
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              RemoteConfigData.getDefaultActionVisibility()==true? SizedBox(width: 10,):SizedBox(),
              RemoteConfigData.getIndividualCaseManagementVisibility()==true?   GestureDetector(
                onTap: (){
