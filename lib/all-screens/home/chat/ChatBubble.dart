      ...
      builder: (context,provider,chidl){
        return GestureDetector(
                       ...
                       children: [
                         GestureDetector(
                           onTap: (){
                             ...
                             //provider.deleteSingleMessage(widget.localmessage, widget.localmessage.time);
          ...
          child: Row(
            ...
            children: [
              SizedBox(width: 10,),
              widget.localmessage.sender == "server" ? ChatAvatar("assets/images/ic_ureport_box.png") : Container(),
              SizedBox(width: 5,),
              Expanded(
                child: Column(
              ...
              widget.localmessage.sender == "server" ? Container() : ChatAvatar("assets/images/ic_user_box.png"),
