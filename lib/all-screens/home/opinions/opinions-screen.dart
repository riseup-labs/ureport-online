                      ...
                      Expanded(
                        child: Container(
                            ...
                            child: TypeAheadFormField<quistoin.Result?>(
                              ...
                              itemBuilder:
                                  (context, quistoin.Result? suggestions) =>
                                      Container(
                                color: Colors.white,
                                child: ListTileTheme(
                              ...
                              onSuggestionSelected:
                                  (quistoin.Result? suggestion) {
                                provider.typeAheadController.text =
                      ...
                      ? Expanded(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                                                      ...
                                                      child: Padding(
                                                          padding:
                                                              EdgeInsets.only(
                                                                  ...
                                                                  top: 2),
                                                          child: Text(
                                                            "${provider.quistionlist[index].results.categories[0].label}",
                                                            style: TextStyle(
                                                                color: Colors
                                                                    .black),
                                                          )),
                                                      ...
                                                      child: Padding(
                                                          padding:
                                                              EdgeInsets.only(
                                                                  ...
                                                                  top: 2),
                                                          child: Text(
                                                            "${provider.quistionlist[index].results.categories[1].label}",
                                                            style: TextStyle(
                                                                color: Colors
                                                                    .black),
                                                          )),
                              ...
                              } else if (provider.resultCategorytype ==
                                  "gender") {
                                return Column(
                                  children: [
                                    Container(
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  Container(
                                                      ...
                                                      child: Text(
                                                          "${provider.quistionlist[index].resultsByGender[j].label}")),
                                                  SizedBox(
                                                    height: 5,
                                                  ),
                                                  ListView.builder(
                                              ...
                                              Column(
                                                ...
                                                children: [
                                                  ...
                                                  Container(
                                                      ...
                                                      child: Text(
                                                          "${provider.quistionlist[index].resultsByAge[j].label}")),
                                                  SizedBox(
                                                    height: 5,
                                                  ),
                                                  ListView.builder(
