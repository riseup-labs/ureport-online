...
const List<FlutterHashtag> kFlutterHashtags = const <FlutterHashtag>[
  ...
  FlutterHashtag('#FlutterSpirit', FlutterColors.blue600, 12, false),
  ...
  FlutterHashtag('#FlutterHashtagOfTheDay', FlutterColors.blue600, 12, false),
  FlutterHashtag('#FlutterCover', FlutterColors.gray600, 20, false),
  FlutterHashtag('#FlutterDream', FlutterColors.blue, 36, false),
  FlutterHashtag('#FlutterAddict', FlutterColors.blue400, 40, false),
  FlutterHashtag('#FlutterDevOps', FlutterColors.gray, 32, false),
  ...
  FlutterHashtag('#FlutterFunCoding', FlutterColors.blue600, 20, false),
  ...
  FlutterHashtag('#FlutterMagicTrick', FlutterColors.blue400, 30, false),
  FlutterHashtag('#FlutterWeekEnd', FlutterColors.gray, 12, false),
  ...
  FlutterHashtag('#FlutterSpeakers', FlutterColors.blue, 22, false),
