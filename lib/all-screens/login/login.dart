...
import 'package:ureport_ecaro/all-screens/login/provider_login_controller.dart';
            ...
            children: [
              ...
              RaisedButton(
                  ...
                  onPressed: ()async{
                    ...
                    await provider.sendmessage("start");
                  }),


              SizedBox(height: 15,),
              RaisedButton(
                  child: Text("send message2"),
                  onPressed: ()async{

                    await provider.sendmessage("No");
                  }),
