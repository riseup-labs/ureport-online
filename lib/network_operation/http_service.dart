...
class HttpService {
  ...
  Future<ApiResponse<Response>> postRequesturlencoded(String route, { Map<String,dynamic>? data, String? jsonData, bool isurlEncoded = false, Function(int sent, int total)? onProgress,}) async {
    try {
