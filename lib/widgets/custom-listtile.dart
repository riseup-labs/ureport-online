...
class ListTileTheme extends InheritedTheme {
  ...
  /// If specified, [shape] defines the [CustomListTile]'s shape.
  /// {@endtemplate}
  ...
  ///
  /// If specified, overrides the default value of [CustomListTile.horizontalTitleGap].
  final double? horizontalTitleGap;

  /// The minimum padding on the top and bottom of the title and subtitle widgets.
  ///
  /// If specified, overrides the default value of [CustomListTile.minVerticalPadding].
  final double? minVerticalPadding;

  /// The minimum width allocated for the [CustomListTile.leading] widget.
  ///
  /// If specified, overrides the default value of [CustomListTile.minLeadingWidth].
  final double? minLeadingWidth;

  /// If specified, defines the feedback property for `ListTile`.
  ///
  /// If [CustomListTile.enableFeedback] is provided, [enableFeedback] is ignored.
...
/// See also:
///
///  * [CheckboxListTile], which combines a [CustomListTile] with a [Checkbox].
///  * [RadioListTile], which combines a [CustomListTile] with a [Radio] button.
///  * [SwitchListTile], which combines a [CustomListTile] with a [Switch].
...
class _RenderListTile extends RenderBox {
  ...
  double get _defaultTileHeight {
    ...
    if (isOneLine)
      return (isDense ? 10.0 : 30.0) + baseDensity.dy;
    if (isTwoLine)
